...
struct {
	wchar_t ch;
	yoperator_t op;
} OPERATORS[] = { { L'*', MultiplyOperator }, { L'/', DivideOperator }, { L'%',
		ModuloOperator }, { L'+', PlusOperator }, { L'-', MinusOperator }, {
		L'(', OpeningParentheseOperator }, { L')', ClosingParentheseOperator },
		{ L'>', GreaterOperator }, { L'<', LesserOperator },
		{ L'&', AndOperator }, { L'|', OrOperator }, { L'^', XorOperator }, {
				L'=', AssignOperator }, { L'!', LogicalNotOperator }, { L'.',
				DotOperator }, { L'[', OpeningBracketOperator }, { L']',
				ClosingBracketOperator }, { L':', ColonOperator }, { L',',
				CommaOperator }, { L'~', NotOperator }, { L'{',
				OpeningBraceOperator }, { L'}', ClosingBraceOperator }, { L'$',
				DollarSignOperator }, { L'?', QueryOperator }, { L';',
				SemicolonOperator } };
...
struct {
	wchar_t* wstr;
	ykeyword_t kw;
} KEYWORDS[] = { { L"null", NullKeyword }, { L"interface", InterfaceKeyword }, {
		L"if", IfKeyword }, { L"else", ElseKeyword },
		{ L"while", WhileKeyword }, { L"do", DoKeyword },
		{ L"for", ForKeyword }, { L"foreach", ForeachKeyword }, { L"pass",
				PassKeyword }, { L"continue", ContinueKeyword }, { L"break",
				BreakKeyword }, { L"object", ObjectKeyword }, {L"scope", ScopeKeyword},
				{ L"var", VarKeyword }, { L"del", DelKeyword },
